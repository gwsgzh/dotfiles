" Name:         qmason
" Author:       Ali Alquied <2k2mason@gmail.com>

" fork of the quiet colorscheme
" TODO: literally everything

" hi clear
source $VIMRUNTIME/colors/vim.lua " Nvim: revert to Vim default color scheme
let g:colors_name = 'qmason'
...
if &background == 'dark'
  ...
  " Constant
  hi Constant guifg=lightgreen guibg=NONE guisp=NONE gui=NONE ctermfg=253 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi Identifier guifg=#ffff00 guibg=NONE guisp=NONE gui=NONE ctermfg=253 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi TabLineSel guifg=#000000 guibg=#00ff00 guisp=NONE gui=bold ctermfg=16 ctermbg=253 cterm=bold term=bold,reverse
